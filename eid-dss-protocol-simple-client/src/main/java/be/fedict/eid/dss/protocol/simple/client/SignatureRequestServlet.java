...
public class SignatureRequestServlet extends HttpServlet {
    ...
    public static final String CONTENT_TYPE_SESSION_ATTRIBUTE_INIT_PARAM =
            "ContentTypeSessionAttribute";

    private static final String SIGNATURE_REQUEST_SERVICE_PARAM =
    ...
    public void init(ServletConfig config) throws ServletException {
        ...
        this.signatureRequestServiceServiceLocator = new
                ServiceLocator<SignatureRequestService>
        ...
        if (null == this.target
            ...
            throw new ServletException(
                    "need to provide either " + TARGET_PARAM
    ...
    protected void doGet(HttpServletRequest request,
        ...
        String signatureRequest = (String) request.getSession()

...
<body>
    ...
    <form id="dss-request-form" method="post" action="${sp.destination}">
        ...
        <input type="hidden" name="ServiceSignature"
               value="${sp.serviceSignature}"/>
        <input type="hidden" name="ServiceCertificateChainSize"
               value="${sp.serviceCertificateChainSize}"/>
        <input type="hidden" name="ServiceCertificate.1"
               value="${sp.serviceCertificate}"/>

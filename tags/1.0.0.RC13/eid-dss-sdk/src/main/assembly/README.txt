README for the FedICT eID Digital Signature Service SDK
=======================================================

=== 1. Introduction

This package contains the FedICT eID DSS SDK. It includes the following
primary artifacts:
...
The license conditions for the eID DSS artifacts can be found in the 
file: LICENSE.txt

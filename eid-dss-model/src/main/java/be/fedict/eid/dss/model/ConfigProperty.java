...
public enum ConfigProperty {
	...
	SIGNATURE_DIGEST_ALGO("signature-digest-algo", DigestAlgo.class, DigestAlgo.SHA512),

	DOCUMENT_STORAGE_EXPIRATION("document-storage-expiration", Integer.class, 5),
	DOCUMENT_CLEANUP_TASK_SCHEDULE("document-cleanup-task-schedule", String.class, "0 0/15 * * * *"),
	...
	SMTP_SERVER("smtp-server", String.class),
	MAIL_FROM("mail-from", String.class),
	MAIL_PREFIX("mail-prefix", String.class),
	MAIL_SIGNED_DOCUMENT("mail-signed-document", Boolean.class),
	SECURITY_REMOVE_CARD("security-remove-card", Boolean.class),
	SECURITY_HSTS("security-hsts", Boolean.class),

	DSS_WS_START("dss-ws-start", String.class, "https://doccle.e-contract.be/dss-ws/start"),
	DSS_WS_URL("dss-ws-url", String.class, "https://doccle.e-contract.be/dss-ws/dss"),
	DSS_WS_USERNAME("dss-ws-username", String.class, ""),
	DSS_WS_PASSWORD("dss-ws-password", String.class, "");
	...
	ConfigProperty(String name, Class<?> type) {
		this.name = name;
		this.type = type;

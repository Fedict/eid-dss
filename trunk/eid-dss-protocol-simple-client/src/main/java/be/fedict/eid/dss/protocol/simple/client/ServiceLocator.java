...
public class ServiceLocator<T> {
         ...
         * @throws javax.servlet.ServletException something went wrong fetching the init
         *                          parameter
         */
         ...
         * @throws javax.servlet.ServletException something went wrong trying to resolve the
         *                          service
         */

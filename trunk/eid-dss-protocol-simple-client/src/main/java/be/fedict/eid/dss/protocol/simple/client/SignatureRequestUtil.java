...
public abstract class SignatureRequestUtil {
    ...
    private static final Log LOG = LogFactory.getLog(SignatureRequestUtil.class);
    ...
    public static void sendRequest(String signatureRequest,
        ...
        velocityProperties.setProperty(JdkLogChute.RUNTIME_LOG_JDK_LOGGER, SignatureRequestUtil.class.getName());
     ...
     *
     * @param spIdentity         the SP Identity used for signing.
     * @param signatureRequest   signature request, if <code>null</code>
     *                           signatureRequestId needs to be specified.
     * @param signatureRequestId signature request ID, if <code>null</code>,
     *                           signatureRequest needs to be specified
     * @param target             required target
     * @param language           optional language param
     * @param contentType        optional document content type
     * @param relayState         optional relay state
     * @return service signature DO containing the signature value,
     *         service signed property listing up all signed properties and
     *         the SP certificate chain.
     * @throws NoSuchAlgorithmException     algorithm to sign/digest not found.
     * @throws InvalidKeyException          signing key not valid
     * @throws SignatureException           signature creation failure
     * @throws CertificateEncodingException certificate encoding failure
     */
